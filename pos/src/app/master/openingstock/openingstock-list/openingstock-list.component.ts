...
@Component({
  selector: 'app-openingstock-list',
  templateUrl: './openingstock-list.component.html',
  styleUrls: ['./openingstock-list.component.css'],
...
export class OpeningstockListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("OpeningStock?StoreID="+this.user_details.storeID + "&limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'documentNo', title: 'Document No', width: '35%' },
      { key: 'documentDate', title: 'Document Date', width: '35%' },
      { key: 'totalQuantity', title: 'Total Quantity', width: '30%' },
      { key: '', title: '' },
    ];
  ...
  //   this.openingstock_Filter = this.openingstock_List;
  // }

  // OpeningStockList() {
  //   this.openingstock_List = null;
  //   this.common.showSpinner();
  //   this.api.getAPI("OpeningStock?StoreID="+this.user_details.storeID)
  //     .subscribe((data) => {
  //       setTimeout(() => {
  //         if (data != null && data.statusCode != null && data.statusCode == 1) {
  //           //this.openingstock_List = data.responseDynamicData;
  //           //this.openingstock_Filter = this.openingstock_List;
  //           this.tblData = data.responseDynamicData;

...
@Component({
  selector: 'app-sales-man-wise-report',
  templateUrl: './sales-man-wise-report.component.html',
  styleUrls: ['./sales-man-wise-report.component.css']
})
export class SalesManWiseReportComponent implements OnInit {
  ...
  fileName = "SALES_SUMMARY_BY_SALESMAN.pdf";
  // set zoom variables
  currentPage = 0;
  ...
  {
    this.common.showSpinner();
    this.api.getAPI("SalesSummaryBySalesman?FromDate=" + this.bindate + "&StoreID="+this.user_details.storeID)
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
  ...
  generatePDF(): void {
    ...
    this.documentDefinition = {
      ...
      content: [
        ...
        {
          text: 'SALES SUMMARY BY SALESMAN',
          fontSize: 12,
          alignment: 'center',
          color: '#050100',
          bold:true
                ...
                ],
                {
                  table: {
                      ...
                      body: [
                        ...
                        {
                            text:'Page\n\n'+this.currentPage +'/'+this.pageVariable,
                            fontSize: 10,
                            border:[false,true,false,true]

      ...
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
            ...
            this.myForm.controls['styleSegmentation'].setValue(data.responseDynamicData.salesType);
            ...
            this.myForm.controls['year'].setValue(data.responseDynamicData.yearID);
  ...
  getSKUMasterData() {
    ...
    this.api.getAPI("sku?ID=" + this.id)
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
            this.myForm.controls['designCode'].setValue(data.skuMasterTypesData.designID);
            ...
            this.myForm.controls['barcode'].setValue(data.skuMasterTypesData.barCode);
            this.myForm.controls['style'].setValue(data.skuMasterTypesData.styleID);
            this.myForm.controls['scale'].setValue(data.skuMasterTypesData.scaleID);
            this.myForm.controls['brand'].setValue(data.skuMasterTypesData.brandID);
            this.getSubBrand();
            this.scaleDetails()
            this.myForm.controls['subBrand'].setValue(data.skuMasterTypesData.subBrandID);
            this.myForm.controls['collection'].setValue(data.skuMasterTypesData.collectionID);
            this.myForm.controls['armadaCollection'].setValue(data.skuMasterTypesData.armadaCollectionID);
            this.myForm.controls['division'].setValue(data.skuMasterTypesData.divisionID);
            this.myForm.controls['productGroup'].setValue(data.skuMasterTypesData.productGroupID);
            this.getproductSubGroup();
            ...
            this.myForm.controls['styleSegmentation'].setValue(data.skuMasterTypesData.segamentationID);
            this.myForm.controls['purchaseCurrency'].setValue(data.skuMasterTypesData.purchaseCurrencyID);
            this.myForm.controls['season'].setValue(data.skuMasterTypesData.seasonID);
            this.myForm.controls['year'].setValue(data.skuMasterTypesData.yearID);
            this.myForm.controls['productLine'].setValue(data.skuMasterTypesData.productLineID);
            this.myForm.controls['status'].setValue(data.skuMasterTypesData.styleStatusID);
            this.myForm.controls['designer'].setValue(data.skuMasterTypesData.designerID);
            this.myForm.controls['rrpPriceList'].setValue(data.skuMasterTypesData.purchasePriceListID);
            this.myForm.controls['rrpCurrency'].setValue(data.skuMasterTypesData.rrpCurrencyID);
            this.myForm.controls['rrpPrice'].setValue(data.skuMasterTypesData.rrpPrice);
            this.myForm.controls['exchangeRate'].setValue(data.skuMasterTypesData.exchangeRate);
            this.myForm.controls['scale'].setValue(data.skuMasterTypesData.scaleID);
            this.myForm.controls['color'].setValue(data.skuMasterTypesData.colorID);
            this.myForm.controls['size'].setValue(data.skuMasterTypesData.sizeID);
            this.styleName = data.skuMasterTypesData.styleName;

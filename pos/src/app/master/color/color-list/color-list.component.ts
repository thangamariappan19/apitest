...
export class ColorListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("color?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'colorCode', title: 'ColorCode', width: '20%' },
      { key: 'description', title: 'Description', width: '20%' },      
      { key: 'shade', title: 'Shade', width: '15%' },
      { key: 'nrfCode', title: 'NRF Code', width: '15%' },
      //{ key: 'colors', title: 'Color', width: '10%' },      
      { key: 'attribute1', title: 'Attribute 1', width: '10%' },
      { key: 'attribute2', title: 'Attribute 2', width: '10%' },
  ...
  //     x => x.colorCode.toLowerCase().includes(name.toLowerCase()) ||
  //       x.description.toLowerCase().includes(name.toLowerCase()) ||
  //       x.shade.toLowerCase().includes(name.toLowerCase()) ||
  //       x.nrfCode.toLowerCase().includes(name.toLowerCase()) ||
  //       //x.colors.toString().includes(name.toLowerCase()) ||
  //       x.attribute1.toLowerCase().includes(name.toLowerCase()) ||
  //       x.attribute2.toLowerCase().includes(name.toLowerCase())
  //   );
  // }
  // getColor(){
  //   this.color = null;
  ...
  //       setTimeout(() => {
  //         if (data != null && data.statusCode != null && data.statusCode == 1) {
  //           //this.color = data.responseDynamicData;
  //           //this.color_Filter = this.color;      
  //           this.tblData= data.responseDynamicData; 

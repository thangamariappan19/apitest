...
export class CollectionListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("collection?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
  ...
  //   this.collectionListFilter = this.collectionList;
  // }
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'collectionCode', title: 'Collection Code', width: '25%' }, // orderBy: 'desc' },
      { key: 'collectionName', title: 'Collection Name', width: '35%' },
  ...
  //   this.collectionListFilter=null;
  //   this.common.showSpinner();
  ...
  // }
  // filter() {
  //   let collectionCode = this.myForm.get('collectionCode').value;
  //   let collectionName = this.myForm.get('collectionName').value;

  //   this.collectionListFilter = this.collectionListFilter;

  //   if (collectionCode != null && collectionCode != "")
  //     this.collectionListFilter = this.collectionListFilter.filter(x => x.collectionCode.toLowerCase().includes(collectionCode.toLowerCase()));

  //   if (collectionName != null && collectionName != "")
  //     this.collectionListFilter = this.collectionListFilter.filter(x => x.collectionName.toLowerCase().includes(collectionName.toLowerCase()));

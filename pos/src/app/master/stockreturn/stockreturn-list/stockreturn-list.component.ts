...
@Component({
  selector: 'app-stockreturn-list',
  templateUrl: './stockreturn-list.component.html',
  styleUrls: ['./stockreturn-list.component.css'],
...
export class StockreturnListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("StockReturn?StoreID="+ this.user_details.storeID + "&StoreCode=" + this.user_details.storeCode + "&limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
  ...
  //   this.stockreturn_Filter = this.stockreturn_List;
  // }

  // StockReturnList() {
  //   this.stockreturn_List = null;
  //   this.common.showSpinner();
  //   this.api.getAPI("StockReturn?storeid=" + this.storeid + "&storeCode=" + this.storeCode)
  //     .subscribe((data) => {
  //       setTimeout(() => {
  //         if (data != null && data.statusCode != null && data.statusCode == 1) {
  //          // this.stockreturn_List = data.responseDynamicData;
  //          //this.stockreturn_Filter = this.stockreturn_List;
  //           this.tblData = data.responseDynamicData;

...
@Component({
  ...
  styleUrls: ['./store-group-list.component.css'],
...
export class StoreGroupListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("storegroup?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
            this.tblData = data.storeGroupMasterList;
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'storeGroupCode', title: 'Store Group Code', width: '40%' },
      { key: 'storeGroupName', title: 'Store Group Name', width: '40%' },
      { key: 'description', title: 'Description', width: '10%' },
  ...
  //     x => x.storeGroupCode.toLowerCase().includes(name.toLowerCase()) ||
  ...
  //           //this.storeGroupList = data.storeGroupMasterList;
  //           //this.storeGroupFilter = this.storeGroupList

  //           this.tblData=data.storeGroupMasterList;
  //           this.tblDataCopy=data.storeGroupMasterList;

...
export class ProductGroupListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("productgroup?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'productGroupCode', title: 'Product Group Code', width: '30%' },
      { key: 'productGroupName', title: 'Product Group Name', width: '30%' },      
  ...
  //   this.productgroup_Filter = this.productgroup;
  // }

  // getProductGroup(){
  //   this.productgroup = null;
  //   this.productgroup_Filter=null;
  //   this.common.showSpinner();
  //   this.api.getAPI("productgroup")
  //     .subscribe((data) => {
  //       setTimeout(() => {
  //         if (data != null && data.statusCode != null && data.statusCode == 1) {
  //           //this.productgroup = data.productGroupList;
  //           //this.productgroup_Filter = this.productgroup;
  //           this.tblData=data.productGroupList;

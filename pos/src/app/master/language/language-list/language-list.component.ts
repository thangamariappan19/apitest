...
export class LanguageListComponent implements OnInit {
  languageList: Array<MLanguageMaster>;
  language_Filter: Array<MLanguageMaster>;
  ...
  private getData(): void {
    ...
    this.api.getAPI("language?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
            this.tblData = data.languageMasterList;
 ...
 /* clear_controls() {
    ...
    this.language_Filter = this.languageList;
  }*/
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'languageCode', title: 'Language Code', width: '25%' }, // orderBy: 'desc' },
      { key: 'languageName', title: 'Language Name', width: '25%' },
      { key: 'remarks', title: 'Remarks', width: '35%' },
 ...
 /* onChange(name: string): void {
    this.tblData = this.tblDataCopy.filter(
      x => x.languageCode.toLowerCase().includes(name.toLowerCase()) ||
 ...
 /* getLanguageList() {
    ...
    this.language_Filter = null;
    this.common.showSpinner();
    this.api.getAPI("language")
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
            //this.json = new Array<MCountryMaster> ();
            //this.languageList = data.languageMasterList;
            //this.language_Filter = this.languageList;
            this.tblData = data.languageMasterList;
            this.tblDataCopy = data.languageMasterList;
          } else {
            let msg: string = data != null
              && data.displayMessage != null
              && data.displayMessage != "" ? data.displayMessage : "Failed to retrieve Data.";

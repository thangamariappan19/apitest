...
@Component({
  selector: 'app-promotion-mapping-list',
  templateUrl: './promotion-mapping-list.component.html',
  styleUrls: ['./promotion-mapping-list.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})

export class PromotionMappingListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("promotionmapping?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
  ...
  //       setTimeout(() => {
  //         if (data != null && data.statusCode != null && data.statusCode == 1) {
  //           //this.promotionList = data.wnPromotionList;
  //           this.tblData = data.wnPromotionList;
  ...
  // }
  // clear_controls() {
  //   this.promotionMapping_Filter = this.promotionList;

...
export class PosListComponent implements OnInit {
  ...
  private getData(): void {
    ...
    this.api.getAPI("pos?limit=" + this.pagination.limit + "&offset=" + this.pagination.offset + "&isActive=" + this.isActive + "&searchString=" + this.searchString)
      .subscribe((data) => {
        setTimeout(() => {
          if (data != null && data.statusCode != null && data.statusCode == 1) {
            this.tblData = data.posMasterList;
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key:'posCode', title: 'POS Code', width: '20%' }, // orderBy: 'desc' },
      { key:'posName', title: 'POS Name', width: '20%' },
      { key:'countryName',title:'Country Name',width:'15%'},
      { key:'storeGroupName',title:'Store GroupName',width:'20%'},
  ...
  //     x => x.posCode.toLowerCase().includes(name.toLowerCase()) ||
  //       x.posName.toLowerCase().includes(name.toLowerCase()) ||
  ...
  //       setTimeout(() => {
  //         if (data != null && data.statusCode != null && data.statusCode == 1) {
  //          // this.posmaster_list = new Array<MPosMaster>();
  //          // this.posmaster_list = data.posMasterList;
  //           this.tblData = data.posMasterList;
  //           this.tblDataCopy = data.posMasterList;
  //         } else {
  //           let msg: string = data != null
  //             && data.displayMessage != null
  //             && data.displayMessage != "" ? data.displayMessage : "Failed to retrieve Data.";

...
@Component({
  selector: 'app-user-previlege-list',
  templateUrl: './user-previlege-list.component.html',
  styleUrls: ['./user-previlege-list.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UserPrevilegeListComponent implements OnInit {
  ...
  dataTableDefault() {
    ...
    this.columnsCopy = [
      { key: 'roleCode', title: 'Role Code', width: '35%' }, // orderBy: 'desc' },
